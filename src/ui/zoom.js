// Pinch and double-tap zoom, refused — on the platformer route only.
//
...
//    double tap zooming; the level is already `touch-action: none`, which
...
// reads, and a recruiter who needs to magnify it must be able to. The platformer
// is a game: a drag on the level is never a scroll, and a zoomed-in
